...
UserNameEL.innerText = `Hello, ${Uname}`
const genres = [
    {
      "id": 28,
      "name": "Action"
          ...
          if(site == 'YouTube'){
              for(let i=0; i<videoData.results.length; i++){
                if(name.includes("Official Trailer")){
                  embed.push(`
                  <iframe width="560" class="yt_player_iframe" id="player_id" height="315" src="https://www.youtube.com/embed/${key}" title="${name}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
